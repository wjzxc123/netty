...
public class DatabaseConfiguration {
	...
	@Qualifier("flowableModeler")
	@Primary
	public SqlSessionTemplate sqlSessionTemplate(@Qualifier("flowableModeler") SqlSessionFactory sqlSessionFactory) {
		return new SqlSessionTemplate(sqlSessionFactory);
	}

	@Bean
	@Qualifier("flowableModeler")
	protected Liquibase liquibase(DataSource dataSource) {
